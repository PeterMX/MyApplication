...
import kotlinx.android.synthetic.main.activity_mm1_c.*

class MM1C : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_mm1_c)
        title = "M/M/1/C"
        supportActionBar?.subtitle = "Población de tamaño C"
